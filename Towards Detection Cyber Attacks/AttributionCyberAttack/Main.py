...
main = tkinter.Tk()
main.title("Vulnerability detection in Cyber-physical Systems") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Vulnerability detection in Cyber-physical Systems')
title.config(bg='yellow', fg='dodger blue')  
title.config(font=font)           
title.config(height=3, width=120)       
title.place(x=0,y=14)
...
autoButton = Button(main, text="AutoEncoder Algorithm", command=runAutoEncoder)
autoButton.place(x=630,y=550)
autoButton.config(font=font1)

dtButton = Button(main, text="Decision Tree with PCA", command=runDecisionTree)
dtButton.place(x=920,y=550)
dtButton.config(font=font1)

dnnButton = Button(main, text="DNN Algorithm", command=runDNN)
dnnButton.place(x=50,y=600)
dnnButton.config(font=font1)

attributeButton = Button(main, text="Attack ", command=attackAttributeDetection)
